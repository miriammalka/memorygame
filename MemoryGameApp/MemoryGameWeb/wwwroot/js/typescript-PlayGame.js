var TypespcriptMemoryGame;
(function (TypespcriptMemoryGame) {
    let scoreDisplay1 = document.querySelector("#scoreplayer1");
    let scoreDisplay2 = document.querySelector("#scoreplayer2");
    ...
    let currentPlayerDisplay = document.querySelector("#currentPlayerDisplay");
    const memorycards = [...document.querySelectorAll(".memory-card")];
    const btnStart = document.querySelector("#btnStart");
    const btnNextTurn = document.querySelector("#btnNextTurn");
...
})(TypespcriptMemoryGame || (TypespcriptMemoryGame = {}));
//# sourceMappingURL=typescript-PlayGame.js.map